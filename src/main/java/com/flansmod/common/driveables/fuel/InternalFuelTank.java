...
public abstract class InternalFuelTank {
	...
	/**
	 * Checks whether the fuel tank has any fuel/energy left at all
	 * @return	False if the fuel tank is completely empty, true otherwise.
	 */
	public abstract boolean hasFuel();
	
	/**
	 * Checks whether the fuel tank has enough fuel/energy for one more tick.
	 * Will return false if amount remaining is not enough for the stated consumption.
