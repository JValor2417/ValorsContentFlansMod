...
public class ModelR700 extends ModelGun //Same as Filename
{
	...
	public ModelR700() //Same as Filename
	{
		...
		gunModel[18] = new ModelRendererTurbo(this, 481, 17, textureX, textureY); // Import Box0
		...
		ammoModel[2] = new ModelRendererTurbo(this, 777, 1, textureX, textureY); // Import Box0
		ammoModel[3] = new ModelRendererTurbo(this, 169, 17, textureX, textureY); // Import Box0
		ammoModel[4] = new ModelRendererTurbo(this, 345, 1, textureX, textureY); // Import Box0

		ammoModel[0].addBox(0F, -17F, 0F, 4, 2, 2, 0F); // Import Box0
		ammoModel[0].setRotationPoint(7F, -10F, -1F);

		ammoModel[1].addBox(0F, -17F, 0F, 1, 1, 1, 0F); // Import Box0
		ammoModel[1].setRotationPoint(19.75F, -9.5F, -0.5F);

		ammoModel[2].addBox(0F, -17F, 0F, 1, 3, 3, 0F); // Import Box0
		ammoModel[2].setRotationPoint(6.75F, -10.5F, -1.5F);

		ammoModel[3].addBox(0F, -17F, 0F, 8, 3, 3, 0F); // Import Box0
		ammoModel[3].setRotationPoint(8.25F, -10.5F, -1.5F);

		ammoModel[4].addBox(0F, -17F, 0F, 4, 2, 2, 0F); // Import Box0
		ammoModel[4].setRotationPoint(16F, -10F, -1F);
