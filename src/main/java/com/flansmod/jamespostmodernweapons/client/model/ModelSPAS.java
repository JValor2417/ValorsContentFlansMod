...
public class ModelSPAS extends ModelGun //Same as Filename
{
	...
	public ModelSPAS() //Same as Filename
	{
		...
		gunModel[18] = new ModelRendererTurbo(this, 617, 9, textureX, textureY); // Import Box0
		gunModel[19] = new ModelRendererTurbo(this, 153, 33, textureX, textureY); // Import Box0
		gunModel[20] = new ModelRendererTurbo(this, 137, 17, textureX, textureY); // Import Box0
		gunModel[21] = new ModelRendererTurbo(this, 649, 17, textureX, textureY); // Import Box0
		gunModel[22] = new ModelRendererTurbo(this, 945, 17, textureX, textureY); // Import Box0
		gunModel[23] = new ModelRendererTurbo(this, 697, 17, textureX, textureY); // Import Box0
		gunModel[24] = new ModelRendererTurbo(this, 601, 25, textureX, textureY); // Import Box0
		...
		gunModel[27] = new ModelRendererTurbo(this, 633, 33, textureX, textureY); // Import Box0
		...
		gunModel[31] = new ModelRendererTurbo(this, 817, 33, textureX, textureY); // Import Box0
		...
		ammoModel[0] = new ModelRendererTurbo(this, 1009, 1, textureX, textureY); // Import Box0
		ammoModel[1] = new ModelRendererTurbo(this, 529, 9, textureX, textureY); // Import Box0
		ammoModel[2] = new ModelRendererTurbo(this, 177, 1, textureX, textureY); // Import Box0
		ammoModel[3] = new ModelRendererTurbo(this, 681, 17, textureX, textureY); // Import Box0

		ammoModel[0].addBox(0F, -17F, 0F, 1, 5, 5, 0F); // Import Box0
		ammoModel[0].setRotationPoint(4.75F, -4F, -2.5F);

		ammoModel[1].addBox(0F, -17F, 0F, 3, 4, 4, 0F); // Import Box0
		ammoModel[1].setRotationPoint(5.25F, -3.5F, -2F);

		ammoModel[2].addBox(0F, -17F, 0F, 1, 3, 3, 0F); // Import Box0
		ammoModel[2].setRotationPoint(16.55F, -3F, -1.5F);

		ammoModel[3].addBox(0F, -17F, 0F, 9, 4, 4, 0F); // Import Box0
		ammoModel[3].setRotationPoint(8.25F, -3.5F, -2F);
