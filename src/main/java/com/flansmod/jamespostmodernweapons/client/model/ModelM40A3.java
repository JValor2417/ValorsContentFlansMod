...
public class ModelM40A3 extends ModelGun //Same as Filename
{
	...
	public ModelM40A3() //Same as Filename
	{
		...
		gunModel[19] = new ModelRendererTurbo(this, 537, 17, textureX, textureY); // Import Box0
		...
		ammoModel[1] = new ModelRendererTurbo(this, 33, 1, textureX, textureY); // Import Box0
		ammoModel[2] = new ModelRendererTurbo(this, 817, 1, textureX, textureY); // Import Box0
		ammoModel[3] = new ModelRendererTurbo(this, 585, 17, textureX, textureY); // Import Box0
		ammoModel[4] = new ModelRendererTurbo(this, 881, 1, textureX, textureY); // Import Box0

		ammoModel[0].addBox(0F, -17F, 0F, 4, 2, 2, 0F); // Import Box0
		ammoModel[0].setRotationPoint(5F, -10F, -2F);

		ammoModel[1].addBox(0F, -17F, 0F, 1, 1, 1, 0F); // Import Box0
		ammoModel[1].setRotationPoint(20.75F, -9.5F, -1.5F);

		ammoModel[2].addBox(0F, -17F, 0F, 1, 3, 3, 0F); // Import Box0
		ammoModel[2].setRotationPoint(4.75F, -10.5F, -2.5F);

		ammoModel[3].addBox(0F, -17F, 0F, 12, 3, 3, 0F); // Import Box0
		ammoModel[3].setRotationPoint(6.25F, -10.5F, -2.5F);

		ammoModel[4].addBox(0F, -17F, 0F, 5, 2, 2, 0F); // Import Box0
		ammoModel[4].setRotationPoint(16F, -10F, -2F);
