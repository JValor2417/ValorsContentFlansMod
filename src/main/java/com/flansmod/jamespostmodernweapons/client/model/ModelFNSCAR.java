...
public class ModelFNSCAR extends ModelGun //Same as Filename
{
	...
	public ModelFNSCAR() //Same as Filename
	{
		...
		gunModel[9] = new ModelRendererTurbo(this, 537, 1, textureX, textureY); // Import Box0
		gunModel[10] = new ModelRendererTurbo(this, 617, 1, textureX, textureY); // Import Box0
		gunModel[11] = new ModelRendererTurbo(this, 705, 1, textureX, textureY); // Import Box0
		gunModel[12] = new ModelRendererTurbo(this, 793, 1, textureX, textureY); // Import Box0
		gunModel[13] = new ModelRendererTurbo(this, 905, 9, textureX, textureY); // Import Box0
		gunModel[14] = new ModelRendererTurbo(this, 369, 9, textureX, textureY); // Import Box0
		gunModel[15] = new ModelRendererTurbo(this, 945, 1, textureX, textureY); // Import Box0
		gunModel[16] = new ModelRendererTurbo(this, 57, 17, textureX, textureY); // Import Box0
		gunModel[17] = new ModelRendererTurbo(this, 281, 17, textureX, textureY); // Import Box0
		gunModel[18] = new ModelRendererTurbo(this, 401, 17, textureX, textureY); // Import Box0
		gunModel[19] = new ModelRendererTurbo(this, 1001, 1, textureX, textureY); // Import Box0
		gunModel[20] = new ModelRendererTurbo(this, 1, 17, textureX, textureY); // Import Box0
		gunModel[21] = new ModelRendererTurbo(this, 121, 17, textureX, textureY); // Import Box0
		gunModel[22] = new ModelRendererTurbo(this, 793, 9, textureX, textureY); // Import Box0
		gunModel[23] = new ModelRendererTurbo(this, 489, 17, textureX, textureY); // Import Box0
		gunModel[24] = new ModelRendererTurbo(this, 601, 17, textureX, textureY); // Import Box0
		gunModel[25] = new ModelRendererTurbo(this, 705, 1, textureX, textureY); // Import Box0
		gunModel[26] = new ModelRendererTurbo(this, 625, 17, textureX, textureY); // Import Box0
		gunModel[27] = new ModelRendererTurbo(this, 169, 25, textureX, textureY); // Import Box0
		gunModel[28] = new ModelRendererTurbo(this, 817, 25, textureX, textureY); // Import Box0
		gunModel[29] = new ModelRendererTurbo(this, 249, 25, textureX, textureY); // Import Box0
		gunModel[30] = new ModelRendererTurbo(this, 345, 17, textureX, textureY); // Import Box0
		gunModel[31] = new ModelRendererTurbo(this, 1001, 17, textureX, textureY); // Import Box0
		gunModel[32] = new ModelRendererTurbo(this, 49, 25, textureX, textureY); // Import Box0
		gunModel[33] = new ModelRendererTurbo(this, 81, 25, textureX, textureY); // Import Box0
		...
		gunModel[7].addBox(0F, -17F, 0F, 36, 3, 3, 0F); // Import Box0
		gunModel[7].setRotationPoint(79.5F, -7.5F, -1.5F);

		gunModel[8].addBox(0F, -17F, 0F, 37, 8, 2, 0F); // Import Box0
		gunModel[8].setRotationPoint(42F, -9.5F, 3F);

		gunModel[9].addBox(0F, -17F, 0F, 36, 8, 2, 0F); // Import Box0
		gunModel[9].setRotationPoint(42F, -9.5F, -5F);

		gunModel[10].addBox(0F, -17F, 0F, 40, 8, 3, 0F); // Import Box0
		...
		gunModel[15].addBox(0F, -17F, 0F, 8, 2, 2, 0F); // Import Box0
		gunModel[15].setRotationPoint(79.5F, -10.5F, -1F);

		gunModel[16].addBox(0F, -17F, 0F, 32, 3, 2, 0F); // Import Box0
		gunModel[16].setRotationPoint(42F, -12.5F, 3F);

		gunModel[17].addBox(0F, -17F, 0F, 32, 3, 2, 0F); // Import Box0
		gunModel[17].setRotationPoint(42F, -12.5F, -5F);

		gunModel[18].addBox(0F, -17F, 0F, 36, 8, 4, 0F); // Import Box0
		...
		gunModel[19].setRotationPoint(78.5F, -11.5F, -2.5F);

		gunModel[20].addBox(0F, -17F, 0F, 2, 11, 7, 0F); // Import Box0
		gunModel[20].setRotationPoint(77.5F, -12.5F, -3.5F);
		...
		gunModel[24].setRotationPoint(82F, -11F, -2F);

		gunModel[25].addBox(0F, -17F, 0F, 1, 2, 2, 0F); // Import Box0
		gunModel[25].setRotationPoint(114.55F, -7F, -1F);

		gunModel[26].addBox(0F, -17F, 0F, 36, 7, 2, 0F); // Import Box0
		gunModel[26].setRotationPoint(42.5F, -9F, 3.5F);

		gunModel[27].addBox(0F, -17F, 0F, 35, 7, 2, 0F); // Import Box0
		gunModel[27].setRotationPoint(42.5F, -9F, -5.5F);

		gunModel[28].addBox(0F, -17F, 0F, 80, 6, 1, 0F); // Import Box0
		...
		defaultScopeModel[6] = new ModelRendererTurbo(this, 817, 1, textureX, textureY); // Import Box0
		defaultScopeModel[7] = new ModelRendererTurbo(this, 857, 1, textureX, textureY); // Import Box0
		defaultScopeModel[8] = new ModelRendererTurbo(this, 1017, 1, textureX, textureY); // Import Box0
		defaultScopeModel[9] = new ModelRendererTurbo(this, 393, 9, textureX, textureY); // Import Box0

		defaultScopeModel[0].addBox(0F, -17F, 0F, 5, 3, 2, 0F); // Import Box0
		defaultScopeModel[0].setRotationPoint(90.5F, -28.5F, -1F);
		defaultScopeModel[0].rotateAngleZ = 1.57079633F;

		defaultScopeModel[1].addBox(0F, -17F, 0F, 2, 1, 1, 0F); // Import Box0
		defaultScopeModel[1].setRotationPoint(91.5F, -32.5F, 1F);
		defaultScopeModel[1].rotateAngleZ = 1.57079633F;

		defaultScopeModel[2].addBox(0F, -17F, 0F, 2, 1, 1, 0F); // Import Box0
		defaultScopeModel[2].setRotationPoint(91.5F, -32.5F, -2F);
		...
		defaultScopeModel[8].setRotationPoint(91F, -30.5F, 1F);
		defaultScopeModel[8].rotateAngleZ = 1.57079633F;

		defaultScopeModel[9].addBox(0F, -17F, 0F, 2, 2, 1, 0F); // Import Box0
		defaultScopeModel[9].setRotationPoint(91F, -30.5F, -2F);
		defaultScopeModel[9].rotateAngleZ = 1.57079633F;


		ammoModel = new ModelRendererTurbo[2];
		ammoModel[0] = new ModelRendererTurbo(this, 817, 1, textureX, textureY); // Import Box0
		ammoModel[1] = new ModelRendererTurbo(this, 865, 1, textureX, textureY); // Import Box0
		...
		slideModel[0] = new ModelRendererTurbo(this, 905, 1, textureX, textureY); // Import Box0
