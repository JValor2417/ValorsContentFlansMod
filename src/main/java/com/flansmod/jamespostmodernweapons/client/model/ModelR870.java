...
public class ModelR870 extends ModelGun //Same as Filename
{
	...
	public ModelR870() //Same as Filename
	{
		...
		ammoModel[0] = new ModelRendererTurbo(this, 1001, 1, textureX, textureY); // Import Box0
		ammoModel[1] = new ModelRendererTurbo(this, 577, 9, textureX, textureY); // Import Box0
		ammoModel[2] = new ModelRendererTurbo(this, 121, 1, textureX, textureY); // Import Box0
		ammoModel[3] = new ModelRendererTurbo(this, 657, 9, textureX, textureY); // Import Box0

		ammoModel[0].addBox(0F, -17F, 0F, 1, 5, 5, 0F); // Import Box0
		ammoModel[0].setRotationPoint(-0.25F, -2F, -2.5F);

		ammoModel[1].addBox(0F, -17F, 0F, 3, 4, 4, 0F); // Import Box0
		ammoModel[1].setRotationPoint(0.25F, -1.5F, -2F);
		...
		ammoModel[3].setRotationPoint(3.25F, -1.5F, -2F);
