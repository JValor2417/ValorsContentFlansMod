...
public class ModelPeaceKeeper extends ModelGun //Same as Filename
{
	...
	public ModelPeaceKeeper() //Same as Filename
	{
		...
		gunModel[11] = new ModelRendererTurbo(this, 897, 1, textureX, textureY); // Import Box0
		gunModel[12] = new ModelRendererTurbo(this, 945, 1, textureX, textureY); // Import Box0
		gunModel[13] = new ModelRendererTurbo(this, 297, 25, textureX, textureY); // Import Box0
		gunModel[14] = new ModelRendererTurbo(this, 489, 33, textureX, textureY); // Import Box0
		gunModel[15] = new ModelRendererTurbo(this, 681, 33, textureX, textureY); // Import Box0
		gunModel[16] = new ModelRendererTurbo(this, 945, 25, textureX, textureY); // Import Box0
		...
		defaultScopeModel[1] = new ModelRendererTurbo(this, 465, 9, textureX, textureY); // Import Box0
		...
		ammoModel[1] = new ModelRendererTurbo(this, 41, 1, textureX, textureY); // Import Box0
		ammoModel[2] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Import Box0
		ammoModel[3] = new ModelRendererTurbo(this, 793, 1, textureX, textureY); // Import Box0

		ammoModel[0].addBox(0F, -17F, 0F, 1, 5, 5, 0F); // Import Box0
		ammoModel[0].setRotationPoint(-0.25F, 3F, -2.5F);

		ammoModel[1].addBox(0F, -17F, 0F, 3, 4, 4, 0F); // Import Box0
		ammoModel[1].setRotationPoint(0.25F, 3.5F, -2F);

		ammoModel[2].addBox(0F, -17F, 0F, 1, 3, 3, 0F); // Import Box0
		ammoModel[2].setRotationPoint(11.55F, 4F, -1.5F);

		ammoModel[3].addBox(0F, -17F, 0F, 9, 4, 4, 0F); // Import Box0
		ammoModel[3].setRotationPoint(3.25F, 3.5F, -2F);
