...
public class ModelM1014 extends ModelGun //Same as Filename
{
	...
	public ModelM1014() //Same as Filename
	{
		...
		gunModel[12] = new ModelRendererTurbo(this, 993, 1, textureX, textureY); // Import Box0
		gunModel[13] = new ModelRendererTurbo(this, 393, 9, textureX, textureY); // Import Box0
		...
		ammoModel[0] = new ModelRendererTurbo(this, 1009, 9, textureX, textureY); // Import Box0
		ammoModel[1] = new ModelRendererTurbo(this, 289, 17, textureX, textureY); // Import Box0
		ammoModel[2] = new ModelRendererTurbo(this, 57, 1, textureX, textureY); // Import Box0
		ammoModel[3] = new ModelRendererTurbo(this, 305, 17, textureX, textureY); // Import Box0

		ammoModel[0].addBox(0F, -17F, 0F, 1, 5, 5, 0F); // Import Box0
		ammoModel[0].setRotationPoint(-0.25F, 0F, -2.5F);

		ammoModel[1].addBox(0F, -17F, 0F, 3, 4, 4, 0F); // Import Box0
		ammoModel[1].setRotationPoint(0.25F, 0.5F, -2F);

		ammoModel[2].addBox(0F, -17F, 0F, 1, 3, 3, 0F); // Import Box0
		ammoModel[2].setRotationPoint(11.55F, 1F, -1.5F);

		ammoModel[3].addBox(0F, -17F, 0F, 9, 4, 4, 0F); // Import Box0
		ammoModel[3].setRotationPoint(3.25F, 0.5F, -2F);
