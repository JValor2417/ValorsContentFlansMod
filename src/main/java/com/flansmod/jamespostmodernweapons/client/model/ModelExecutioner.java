...
public class ModelExecutioner extends ModelGun //Same as Filename
{
	...
	public ModelExecutioner() //Same as Filename
	{
		...
		gunModel[15] = new ModelRendererTurbo(this, 361, 1, textureX, textureY); // Box 34
		...
		gunModel[11].addBox(0F, -17F, 0F, 12, 22, 13, 0F); // Import Box0
		gunModel[11].setRotationPoint(6F, -31.5F, -6F);
		gunModel[11].rotateAngleZ = -1.57079633F;

		gunModel[12].addBox(0F, -17F, 0F, 10, 8, 9, 0F); // Import Box0
		gunModel[12].setRotationPoint(-16F, -29F, -4.5F);
		...
		ammoModel[0] = new ModelRendererTurbo(this, 505, 1, textureX, textureY); // Import Box0
		ammoModel[1] = new ModelRendererTurbo(this, 521, 1, textureX, textureY); // Import Box0
		ammoModel[2] = new ModelRendererTurbo(this, 537, 1, textureX, textureY); // Import Box0
		ammoModel[3] = new ModelRendererTurbo(this, 553, 1, textureX, textureY); // Import Box0
		ammoModel[4] = new ModelRendererTurbo(this, 585, 1, textureX, textureY); // Import Box0
		ammoModel[5] = new ModelRendererTurbo(this, 601, 1, textureX, textureY); // Import Box0
		ammoModel[6] = new ModelRendererTurbo(this, 617, 1, textureX, textureY); // Import Box0
		ammoModel[7] = new ModelRendererTurbo(this, 633, 1, textureX, textureY); // Import Box0

		ammoModel[0].addBox(0F, -17F, 0F, 1, 5, 5, 0F); // Import Box0
		ammoModel[0].setRotationPoint(23.75F, -13F, -5.5F);

		ammoModel[1].addBox(0F, -17F, 0F, 3, 4, 4, 0F); // Import Box0
		ammoModel[1].setRotationPoint(24.25F, -12.5F, -5F);

		ammoModel[2].addBox(0F, -17F, 0F, 1, 3, 3, 0F); // Import Box0
		ammoModel[2].setRotationPoint(35.55F, -12F, -4.5F);

		ammoModel[3].addBox(0F, -17F, 0F, 9, 4, 4, 0F); // Import Box0
		ammoModel[3].setRotationPoint(27.25F, -12.5F, -5F);

		ammoModel[4].addBox(0F, -17F, 0F, 1, 5, 5, 0F); // Import Box0
		ammoModel[4].setRotationPoint(23.75F, -13F, 1.5F);

		ammoModel[5].addBox(0F, -17F, 0F, 3, 4, 4, 0F); // Import Box0
		ammoModel[5].setRotationPoint(24.25F, -12.5F, 2F);

		ammoModel[6].addBox(0F, -17F, 0F, 1, 3, 3, 0F); // Import Box0
		ammoModel[6].setRotationPoint(35.55F, -12F, 2.5F);

		ammoModel[7].addBox(0F, -17F, 0F, 9, 4, 4, 0F); // Import Box0
		ammoModel[7].setRotationPoint(27.25F, -12.5F, 2F);
		...
		breakActionModel[5] = new ModelRendererTurbo(this, 321, 1, textureX, textureY); // Box 34
		breakActionModel[6] = new ModelRendererTurbo(this, 449, 1, textureX, textureY); // Import Box0
		breakActionModel[7] = new ModelRendererTurbo(this, 481, 1, textureX, textureY); // Import Box0
