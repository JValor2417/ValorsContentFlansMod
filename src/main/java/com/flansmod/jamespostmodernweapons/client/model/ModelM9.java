...
public class ModelM9 extends ModelGun //Same as Filename
{
	...
	public ModelM9() //Same as Filename
	{
		...
		gunModel[9] = new ModelRendererTurbo(this, 345, 1, textureX, textureY); // Import Box0
		...
		gunModel[7].addBox(0F, -17F, 0F, 3, 6, 5, 0F); // Import Box0
		gunModel[7].setRotationPoint(22F, -26F, -2.5F);
		gunModel[7].rotateAngleZ = -1.57079633F;

		gunModel[8].addBox(0F, -17F, 0F, 2, 7, 4, 0F); // Import Box0
		gunModel[8].setRotationPoint(-18F, -23F, -2F);
		gunModel[8].rotateAngleZ = -1.57079633F;

		gunModel[9].addBox(0F, -17F, 0F, 4, 1, 3, 0F); // Import Box0
		gunModel[9].setRotationPoint(6F, -38F, -1.5F);
		gunModel[9].rotateAngleZ = 2.46091425F;

		gunModel[10].addBox(0F, -17F, 0F, 3, 6, 3, 0F); // Import Box0
		gunModel[10].setRotationPoint(26F, -29.5F, -1.5F);
