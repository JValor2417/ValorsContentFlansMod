...
public class ModelW1200 extends ModelGun //Same as Filename
{
	...
	public ModelW1200() //Same as Filename
	{
		...
		ammoModel[1] = new ModelRendererTurbo(this, 993, 9, textureX, textureY); // Import Box0
		ammoModel[2] = new ModelRendererTurbo(this, 329, 17, textureX, textureY); // Import Box0
		ammoModel[3] = new ModelRendererTurbo(this, 121, 1, textureX, textureY); // Import Box0
		ammoModel[4] = new ModelRendererTurbo(this, 817, 17, textureX, textureY); // Import Box0

		ammoModel[0].addBox(0F, 0F, 0F, 13, 5, 5, 0F); // Box 19
		ammoModel[0].setRotationPoint(2F, -19F, -2F);

		ammoModel[1].addBox(0F, -17F, 0F, 1, 5, 5, 0F); // Import Box0
		ammoModel[1].setRotationPoint(-0.25F, -3F, -2.5F);

		ammoModel[2].addBox(0F, -17F, 0F, 3, 4, 4, 0F); // Import Box0
		ammoModel[2].setRotationPoint(0.25F, -2.5F, -2F);

		ammoModel[3].addBox(0F, -17F, 0F, 1, 3, 3, 0F); // Import Box0
		ammoModel[3].setRotationPoint(11.55F, -2F, -1.5F);

		ammoModel[4].addBox(0F, -17F, 0F, 9, 4, 4, 0F); // Import Box0
		ammoModel[4].setRotationPoint(3.25F, -2.5F, -2F);
